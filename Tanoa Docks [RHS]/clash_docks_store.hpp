...
class bluforWeapons
{
	...
	class Items {
		...
		class rhs_mag_20Rnd_762x51_m80_fnfal {
			displayName = "[L1A1] Ammunition";
			description = "Three magazines of 7.62mm ammunition for the L1A1";
			amount = 3;
			price = 150;
			stock = 999;
		};
		class rhsusf_20Rnd_762x51_SR25_m118_special_Mag {
			displayName = "[Mk 11 Mod 0] Ammunition";
			description = "Three magazines of 7.62mm ammunition for the Mk 11 Mod 0";
			amount = 3;
			price = 150;
			stock = 999;
		};
		...
		class rhsusf_5Rnd_762x51_m118_special_Mag {
			displayName = "[M24 SWS] Ammunition";
			description = "Three magazines of 7.62x51mm ammunition for the M24 SWS";
			amount = 3;
			price = 50;
			stock = 999;
		};
	...
	class Wearables {
		...
		class U_B_T_FullGhillie_tna_F {
			displayName = "Jungle Ghillie Suit";
			description = "";
			amount = 1;
			price = 300;
			stock = 999; 
